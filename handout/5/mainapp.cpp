 ...
 * output.   The implementation  of the  merge sort  algorithm  is the
 * top-down one, and  it is combined with the  insertion sort, so that
 * when the subarrays  become small, they are sorted  by the insertion
 * sort.
 *
 * \author
