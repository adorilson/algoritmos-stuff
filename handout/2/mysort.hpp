...
public:
  ...
  /**
   * \fn double get_the_number_of_key_comparisons() const
   *
   ...
   */
  double get_the_number_of_key_comparisons() const
  {
    return _ncomps ;
  }
  ...
  /**
   * \fn double get_the_number_of_array_accesses() const
   *
   ...
   * execution of the sorting method.
   */
  double get_the_number_of_array_accesses() const
  {
    return _nacces ;
  }
...
protected:
  ...
  double _ncomps ;   ///< number of key comparisons of the sorting method.
  double _nacces ;   ///< number of array accesses of the sorting method.
