 ...
 * output. The  implementatino of the merge sort  algorithm contains a
 * not  so  effective  optimization.   This optimization  consists  of
 * merging sorted subarrays (i.e., it  does not matter their sizes, as
 * long as they are sorted). The point here is to empirically find out
 * evidences  that the proposed  optimization does  not gives  us much
 * (with respect to the non-optimized implementation of the merge sort
 * algorithm.)
 *
 * \author
...
/* \fn void print(int* a, int l, int r)
 *
 * \brief Prints a subarray  of a given array  of integers delimited by two
                                                      	                                                                  	 *  given indices.
 */
